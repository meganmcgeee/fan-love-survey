 ...
 pages: [
  {
   ...
   elements: [
    ...
    {
     type: "checkbox",
     name: "Who will be joining you when you go to E3 2018?",
     choices: [
      {
       value: "1",
       text: "My partner(s)"
  ...
  {
   name: "What do you like to do when attending E3 ALONE?",
   elements: [
    {
     type: "panel",
...
function sendDataToServer(survey) {
    survey.sendResult('e391464d-0926-4e7d-b859-9b34c19dfed8');
}
